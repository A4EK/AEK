...
|  This Is The Source Channel @mx_aa .   |
|               - AEK -                 |
---------------------------------------------
]]..'\27[m'.."\n\27[35mServer Information ↬ ⤈ \n━───━ ♕ ━───━ ♕ ━───━ ♕ ━───━\27[m\n\27[36m~ \27[mUser \27[36m: \27[10;32m"..User.."\27[m\n\27[36m~ \27[mIp \27[36m: \27[10;32m"..Ip.."\27[m\n\27[36m~ \27[mName \27[36m: \27[10;32m"..Name.."\27[m\n\27[36m~ \27[mPort \27[36m: \27[10;32m"..Port.."\27[m\n\27[36m~ \27[mUpTime \27[36m: \27[10;32m"..UpTime.."\27[m\n\27[35m━───━ ♕ ━───━ ♕ ━───━ ♕ ━───━\27[m")
Config = dofile("./config.lua")
DevId = Config.DevId
SudoIds = {Config.SudoIds,1612604311}
AEK = Config.AEK
TokenBot = Config.TokenBot
NameBot = (DevAek:get(AEK..'Aek:NameBot') or 'البشير')
...
local UserName = (dp.username_ or "mx_aa")
...
if text and text:match('^'..(DevAek:get(AEK..'Aek:NameBot') or "البشير")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAek:get(AEK..'Aek:NameBot') or "البشير")..' ','')
end
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'mx_aa')..')'..' ❩\n♕︙تم رفعه ❨ '..DEV_AEEKAN..' ❩ بنجاح', 1, 'md')
...
if mrAek == "مميز" and VipMem(msg) then
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'mx_aa')..')'..' ❩\n♕︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '♕︙اهلا بك مجددا عزيزي المطور \n♕︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس البشير فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local inline = {{{text="♕ المطور .",url="t.me/"..(dp.username_ or "mx_aa")}}}
...
Dev_Aek(msg.sender_user_id_, msg.id_, 1, '♕︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "mx_aa")..')', 1, 'md') 
...
local text = text:gsub('username',(result.username_ or 'mx_aa'))
...
local text = text:gsub('username',(msg.content_.members_[0].username_ or 'mx_aa'))
Dev_Aek(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
local BotName = (DevAek:get(AEK.."Aek:NameBot") or 'البشير')
...
if text and text == (DevAek:get(AEK..'Aek:NameBot') or 'البشير') then 
NameBot = (DevAek:get(AEK..'Aek:NameBot') or 'البشير')
...
♕︙[𝑬𝑿𝑷 𝑺𝑶𝑼𝑹𝑪𝑬](https://t.me/mx_aa)

♕︙[𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](https://t.me/Ma_ag6)

♕︙[𝑷𝑹𝑶𝑮𝑹𝑨𝑴𝑴𝑬𝑹](https://t.me/A3kon)

━───━ ♕ ━───━
♕︙[Tws ALBSHEER](https://t.me/AekanBot)
]]
Dev_Aek(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
if tonumber(result.id_) == tonumber(1612604311) then 
Dev_Aek(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1612604311) then  
Dev_Aek(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/mx_aa' end
...
ConstructorAek = "["..Aek.first_name_.."](T.me/"..(Aek.username_ or "mx_aa")..")"
else 
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙جاري تحديث سورس البشير', 1, 'md') 
os.execute('rm -rf AEK.lua') 
os.execute('wget https://raw.githubusercontent.com/A4EK/AEK/master/AEK.lua') 
dofile('AEK.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/A4EK/AEKFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n♕︙قائمة ملفات متجر سورس البشير\n♕︙الملفات المتوفره حاليا ↫ ⤈\n━───━ ♕ ━───━\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/A4EK/AEKFiles/master/AEKFiles/"..FileName)
if Res == 200 then
...
Dev_Aek(msg.chat_id_, msg.id_, 1, '♕︙Channel ↬ @mx_aa', 1, 'html')    
end 
